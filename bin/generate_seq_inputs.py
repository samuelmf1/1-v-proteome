...
def parse_args():
    ...
    parser.add_argument("--seqs", required=True, help="Path to STRING sequences fasta.gz")
...
def main():
    ...
    # 3. Stream STRING sequences and generate JSONs
            ...
            def process_sequence(sid, sseq):
                ...
                for t, t_id_clean in sanitized_targets:
                    if args.filetype == 'json':
                        ...
                        # Entity A (Target)
                        id_a = "A"
                        # Use D for DNA if preferred, but sticking to A/B is safer unless logic dictates distinct IDs
